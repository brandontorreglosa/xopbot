...
const nsfwSchema = require("../../MODELS/REGISTER-NSFW");
...
try {
  module.exports = async (Discord, client, message) => {
    ...
    const antilinkData = require('../../MODELS/ANTI-LINK');
    ...
    const antiprefixData = require('../../MODELS/ANTI-PREFIX');
    client.on("message", async (message) => {
    ...
    const antiwordsData = require('../../MODELS/ANTI-WORDS');
    client.on("message", async (message) => {
    ...
    const welcomemsg = require("../../MODELS/JOIN-MSG");
    ...
    const byeData = require("../../MODELS/LEAVE-CHANNEL");
    const byemsg = require("../../MODELS/LEAVE-MSG");
