...
module.exports = {
  ...
  async execute(client, message, cmd, args, Discord) {
    if (cmd === 'ticket-set') {
      ...
      const fakbutton1 = new MessageButton().setStyle('red').setID(id4).setLabel('Close').setEmoji('⛔').setDisabled(true)
      const fakbutton2 = new MessageButton().setStyle('green').setLabel('Lock').setID(id5).setEmoji('🔒').setDisabled(true)
      const fakbutton3 = new MessageButton().setStyle('red').setID(id6).setLabel('Close').setEmoji('⛔').setDisabled(true)
      ...
      const row3 = new MessageActionRow().addComponents(fakbutton2, fakbutton3);
