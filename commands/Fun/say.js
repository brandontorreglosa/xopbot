...
module.exports = {
    ...
    async execute(client, message, cmd, args, Discord) {
        ...
        try {
            ...
            if (!args[0]) {
                message.channel.send({ content: "**Please Add Some Text For Me XOPBOT To Repeat!**" })
            }
            ...
            if (sayMessage.length > 100) return message.channel.send({ content: '**You Are Not Allowed To Go Over 100 Characters!**' });
