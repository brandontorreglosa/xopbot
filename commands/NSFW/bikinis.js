...
module.exports = {
      ...
      async execute(client, message, cmd, args, Discord) {
            ...
            got('https://www.reddit.com/r/bikinis/random.json').then(response => {
                  ...
                  let wow = new discord.MessageEmbed().setTimestamp().setDescription(`:underage: **Bikinis**\n**[Provided To You By The Bot Supporters Of XOPBOT](${amazeme})**`).setImage(amazeme).setFooter(`That Bikini Is So Sexy On You! :)`).setColor(`${color}`)
