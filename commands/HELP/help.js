...
module.exports = {
    ...
    async execute(client, message, cmd, args, Discord) {
        ...
        if (cmd === 'help') {
            ...
            const embed = new Discord.MessageEmbed().setTitle(`XOPBOT's Commands`).setTimestamp().setColor(`${color}`).setDescription("**XOPBOT Is A Multipurpose Bot With Over 200+ Commands!**").addFields({ name: '🛠️ Moderation', value: 'Access All Moderation Commands By Typing `x!mod`' }, { name: '⚙ Utility', value: 'Access All Utility Commands By Typing `x!utils`' }, { name: '<:dankhype:825049281299611718> Config', value: 'Access All Config Commands By Typing `x!config`' }, { name: '<:dankmemer3:824890108041232394> Owner', value: 'Private Commands (Owner Only) `x!owner`' }, { name: '🐛 Bugs', value: 'Access All Bug Commands By Typing `x!bugs`' }, { name: '📈 Status', value: 'Access All Status Commands By Typing `x!status`' }).setFooter(`https://xopbot.glitch.me | Page 1`, client.user.displayAvatarURL())
            const embedpag1 = new Discord.MessageEmbed().setTitle(`XOPBOT's Commands`).setTimestamp().setColor(`${color}`).setDescription("**XOPBOT Is A Multipurpose Bot With Over 200+ Commands!**").addFields({ name: '💬 Socials', value: 'Access All Social Commands By Typing `x!socials`' }, { name: '<:SILENCE_liberal:824886939520991242> Games', value: 'Access All Game Commands Typing `x!games`' }, { name: '<:KEKW:829300759194501140> Fun', value: 'Access All Fun Commands Typing `x!fun`' }, { name: '<:BonkGoToHornyJail:824886935091675177> Images', value: 'Access All Image Commands Typing `x!images`' }, { name: '🎶 Music', value: 'Access All Music Commands Typing `x!music`' }, { name: '🤑 Economy', value: 'Access All Economy Commands Typing `x!economy`' }).setFooter(`https://xopbot.glitch.me | Page 2`, client.user.displayAvatarURL())
            const embedpag2 = new Discord.MessageEmbed().setTitle(`XOPBOT's Commands`).setTimestamp().setColor(`${color}`).setDescription("**XOPBOT Is A Multipurpose Bot With Over 200+ Commands!**").addFields({ name: '🎉 Giveaway', value: 'Create A Giveaway By Typing `x!giveaway`' }, { name: '<:Stonks:824886940079489025> Leveling', value: 'Access All Leveling Commands By Typing `x!leveling`' }, { name: '🔞 NSFW', value: 'Access All Nsfw Commands By Typing `x!nsfw`' }, { name: '👑 Premium', value: 'Private Commands (Donors Only)`x!premium`' }, { name: '🔗 Invites', value: 'Access All Invite Commands By Typing `x!invites`' }, { name: '🤖 Credits', value: 'Just The Bot Credits (View Them) `x!credits`' }).setFooter(`https://xopbot.glitch.me | Page 3`, client.user.displayAvatarURL())
