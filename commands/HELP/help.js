...
module.exports = {
    ...
    async execute(client, message, cmd, args, Discord) {
        ...
        if (cmd === 'help') {
            ...
            const embed = new Discord.MessageEmbed().setTitle(`XOPBOT's Commands`).setTimestamp().setColor(`${color}`).setDescription("**XOPBOT Is A Multipurpose Bot With Over 200+ Commands!**").addFields({ name: '🛠️ Moderation', value: '**Type `x!mod` To View Moderation Commands**' }, { name: '⚙ Utility', value: '**Type `x!utils` To View Utility Commands**' }, { name: '<:dankhype:825049281299611718> Config', value: '**Type `x!config` To View Config Commands**' }, { name: '<:dankmemer3:824890108041232394> Owner', value: '**You Can\'t Type `x!owner` (Owner Only)**' }, { name: '🐛 Bugs', value: '**Type `x!bugs` To View Bug Commands**' }, { name: '📈 Status', value: '**Type `x!status` To View Status Commands**' }).setFooter(`https://xopbot.glitch.me | Page 1`, client.user.displayAvatarURL())
            const embedpag1 = new Discord.MessageEmbed().setTitle(`XOPBOT's Commands`).setTimestamp().setColor(`${color}`).setDescription("**XOPBOT Is A Multipurpose Bot With Over 200+ Commands!**").addFields({ name: '💬 Socials', value: '**Type`x!socials` To View Social Commands**' }, { name: '<:SILENCE_liberal:824886939520991242> Games', value: '**Type `x!games` To View Game Commands**' }, { name: '<:KEKW:829300759194501140> Fun', value: '**Type `x!fun` To View Fun Commands**' }, { name: '<:BonkGoToHornyJail:824886935091675177> Images', value: '**Type `x!images` To View Image Commands**' }, { name: '🎶 Music', value: '**Type `x!music` To View Music Commands**' }, { name: '🤑 Economy', value: '**Type `x!economy` To View Economy Commands**' }).setFooter(`https://xopbot.glitch.me | Page 2`, client.user.displayAvatarURL())
            const embedpag2 = new Discord.MessageEmbed().setTitle(`XOPBOT's Commands`).setTimestamp().setColor(`${color}`).setDescription("**XOPBOT Is A Multipurpose Bot With Over 200+ Commands!**").addFields({ name: '🎉 Giveaway', value: '**Type `x!giveaway` To Create A Giveaway**' }, { name: '<:Stonks:824886940079489025> Leveling', value: '**Type `x!leveling` To View Leveling Commands**' }, { name: '🔞 NSFW', value: '**Type `x!nsfw` To View NSFW Commands**' }, { name: '👑 Premium', value: '**You Can\'t Type `x!premium` (Donors Only)**' }, { name: '🔗 Invites', value: '**Type `x!invites` To View Invite Commands**' }, { name: '🤖 Credits', value: '**Type `x!credits` To View The Credits**' }).setFooter(`https://xopbot.glitch.me | Page 3`, client.user.displayAvatarURL())
