                ...
                if (!hasItem) {
                    ...
                    if (random() === true) {
                        ...
                        const bootembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**LMFAO! You Just Shot A \`🥾\`, What A Loser 🤣. Its Worth \`${Boot}\` Xocoins!**`)
                        ...
                        const yellowfishembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**LMAO! You Just Shot A \`🐑\`, What A Noob 😂. Its Worth \`${YellowFish}\` Xocoins!**`)
                        ...
                        const fatfishembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**LOL! You Just Shot A \`🐏\`, What A Bot 😆. Its Worth \`${FatFish}\` Xocoins!**`)
                        ...
                        const bluefishembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**OK! You Just Shot A \`🐖\`, What A Rookie 😁. Its Worth \`${BlueFish}\` Xocoins!**`)
                        ...
                        const dolphinembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**Well Done! You Just Shot A \`🐄\`, What A Newbie 👶. Its Worth \`${Dolphin}\` Xocoins!**`)
                        ...
                        const lobsterembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**Congrats! You Just Shot A \`🐎\`, What A Professional 🧑‍🏫. Its Worth \`${Lobster}\` Xocoins!**`)
                        ...
                        const sharkembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**WTH! You Just Shot A \`🎠\`, What A Thug 😎. Its Worth \`${Shark}\` Xocoins!**`)
                        ...
                        const crabembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**WTF! You Just Shot A \`🐈\`, What A Mafia Boss 🕵️‍♂️. Its Worth \`${Crab}\` Xocoins!**`)
                        ...
                        const squidembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**OMG! You Just Shot A \`🐈‍⬛\`, What A Hunterman 🔫. Its Worth \`${Squid}\` Xocoins!**`)
                        ...
                        const whaleembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**OMFG! You Just Shot A \`🐅\`, What A Demolitioner 💣. Its Worth \`${Whale}\` Xocoins!**`)
                        ...
                        const shrimpembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**WTH, OMG! You Just Caught A \`🐂\`, What A Sniper 🏹. Its Worth \`${Shrimp}\` Xocoins!**`)
                        ...
                        const octopusembed = new Discord.MessageEmbed()
                            ...
                            .setColor(`${color}`)
                            .setAuthor(`${message.author.username}`, message.author.displayAvatarURL({ dynamic: true }))
                            .setDescription(`**WTF, OMFG! You Just Caught A \`🐆\`, What A Tank 🚋. Its Worth \`${Octopus}\` Xocoins!**`)
