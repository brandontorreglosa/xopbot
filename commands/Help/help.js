...
module.exports = {
    ...
    async execute(client, message, cmd, args, Discord) {
        ...
        if (cmd === 'help') {
            ...
            const row = new MessageActionRow().addComponents(button, button2, button3, button19); const embed = new Discord.MessageEmbed().setAuthor(`XOPBOT Commands`, client.user.displayAvatarURL({ dynamic: true })).setThumbnail(client.user.displayAvatarURL()).setTimestamp().setImage('https://cdn.discordapp.com/attachments/824319314495537175/861288765145088030/standard_1.gif').setColor(`${color}`).addFields({ name: '__🛠️ Moderation__', value: '`x!moderation`', inline: true }, { name: '__⚙ Utility__', value: '`x!utility`', inline: true }, { name: '__<:dankhype:825049281299611718> Config__', value: '`x!config`', inline: true }, { name: '__<:dankmemer3:824890108041232394> Owner__', value: '`x!owner`', inline: true }, { name: '__🐛 Bugs__', value: '`x!bugs`', inline: true }, { name: '__📈 Status__', value: '`x!status`', inline: true }, { name: '__💬 Socials__', value: '`x!socials`', inline: true }, { name: '__<:SILENCE_liberal:824886939520991242> Games__', value: '`x!games`', inline: true }, { name: '__<:KEKW:829300759194501140> Fun__', value: '`x!fun`', inline: true }, { name: '__<:BonkGoToHornyJail:824886935091675177> Images__', value: '`x!images`', inline: true, }, { name: '__🎶 Music__', value: '`x!music`', inline: true }, { name: '__🤑 Economy__', value: '`x!economy`', inline: true }, { name: '__🎉 Giveaway__', value: '`x!giveaway`', inline: true }, { name: '__<:Stonks:824886940079489025> Leveling__', value: '`x!leveling`', inline: true }, { name: '__🔞 NSFW__', value: '`x!nsfw`', inline: true }, { name: '__👑 Premium__', value: '`x!premium`', inline: true }, { name: '__🔗 Invites__', value: '`x!invites`', inline: true }, { name: '__🤖 Credits__', value: '`x!credits`', inline: true }, { name: '__📢 Announcment__', value: '```Updating The 📷 Image Commands! \nPlease Dont Use Them Yet 🥺```' }).setFooter(`Created By: ${message.author.tag}`, message.author.displayAvatarURL())
